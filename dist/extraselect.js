...
function He(e, t) {
  var i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, n, s, r, o = function(l) {
    ...
    if (r = f, !(n && l === s)) {
      var m = i.leading;
      typeof m == "function" && (m = m(l, s)), (!n || l !== s) && m && e.apply(void 0, [l].concat(re(r))), s = l, clearTimeout(n), n = setTimeout(function() {
        e.apply(void 0, [l].concat(re(r))), n = 0;
      }, t);
    }
  };
  ...
  return Le(e, [{
    ...
    value: function(i, n) {
      ...
      if (this.observer && this.destroyObserver(), !this.frozen) {
        if (this.options = Be(i), this.callback = function(a, l) {
        ...
        this.oldResult = void 0, this.observer = new IntersectionObserver(function(a) {
          ...
          if (s.callback) {
            var f = l.isIntersecting && l.intersectionRatio >= s.threshold;
            if (f === s.oldResult)
              return;
            s.oldResult = f, s.callback(f, l);
          }
...
function Qe() {
  return this.items.length && j(this.items[0]) !== "object";
}
var Y = !1;
if (typeof window < "u") {
  Y = !1;
  ...
  methods: {
    ...
    updateVisibleItems(e, t = !1) {
      ...
      for (let v = m; v < h; v++) {
        ...
        if (u = b.get(k), !i && !l[v].size) {
          u && this.unuseView(u);
          continue;
        }
        u ? (u.nr.used = !0, u.item = p) : (c = p[s], S = f.get(c), E ? S && S.length ? (u = S.pop(), u.item = p, u.nr.used = !0, u.nr.index = v, u.nr.key = k, u.nr.type = c) : u = this.addView(d, v, p, k, c) : (N = w.get(c) || 0, (!S || N >= S.length) && (u = this.addView(d, v, p, k, c), this.unuseView(u, !0), S = f.get(c)), u = S[N], u.item = p, u.nr.used = !0, u.nr.index = v, u.nr.key = k, u.nr.type = c, w.set(c, N + 1), N++), b.set(k, u)), i === null ? u.position = l[v - 1].accumulator : u.position = v * i;
      }
...
function nt(e, t, i, n, s, r) {
  const o = be("ResizeObserver"), a = ge("observe-visibility");
  return W((y(), C("div", {
    ...
    q("div", {
      ...
      (y(!0), C(A, null, K(s.pool, (l) => (y(), C("div", {
        key: l.nr.id,
...
const lt = (e) => {
  ...
  const o = function(f, d) {
    ...
    return r === "inherit" ? f : r == null || r === "dynamic" ? Math.max(f, Math.max(...e.value.map((m) => o(m.value))) + 15) : r;
  }), b = I({
    position: "absolute",
  ...
  setup(e) {
    ...
    lt(t.originalNode);
    const { filterText: r, filteredOptions: o } = ct(n, t.minChars), { searchingFlag: a } = ut(
      n,
      t.url,
      t.searchableUrl,
      r,
    ...
    if (!t.keepOpen) {
      const w = function(p) {
        const c = st(p.target);
        c.push(p.target), !c.includes(l.value) && !c.includes(b.value) && (d.value = !1);
      };
      _e(() => {
        ...
        W(_("div", {
          ...
          g(r).length >= t.minChars ? (y(), z(A, { key: 1 }, [
            g(i) ? (y(), z(A, { key: 0 }, [
              ...
              g(o).length > 0 && g(r).length > 0 ? (y(), z("div", {
                key: 1,
                onClick: p[4] || (p[4] = (c) => s.value = g(o).map((S) => S.key))
              }, gt)) : T("", !0),
              _("div", {
