...
export const loadStyling = (options,selectedOptions,open,inputNode,dropdownNode,propMaxWidth) => {
    ...
    const maxWidth = computed(() => {
      ...
      watchPostEffect(() => {
        ...
        dropdownStyle.value = {
            ...
            top:(inputOffset.top + inputOffset.height).toString() +
                "px",
            left: (inputOffset.left).toString() + "px",
        };    
      });
